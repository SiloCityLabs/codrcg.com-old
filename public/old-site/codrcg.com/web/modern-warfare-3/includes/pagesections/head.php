...
?>
	...
	<link rel="apple-touch-icon" href="/<?php echo MW3_Folder; ?>/apple-touch-icon.png">
    <link rel="android-touch-icon" href="/<?php echo MW3_Folder; ?>/apple-touch-icon.png">
    <meta name="google-play-app" content="app-id=com.techreanimate.blackops3">
    <link rel='shortcut icon' href='/<?php echo MW3_Folder; ?>/favicon.ico' type='image/x-icon' />
	...
	<?php
		...
		echo minify_builder([
			...
			'files'=>[
				...
				MW3_Folder .'/assets/scripts/_app/app.js',
				'assets/scripts/_app/BootstrapMediaQuieres.js',
				'assets/scripts/_app/filters/filters.js',
				MW3_Folder .'/assets/scripts/_app/main/main.controller.js',
				MW3_Folder .'/assets/scripts/_app/main/main.service.js',
...
<div itemscope itemtype="http://data-vocabulary.org/Breadcrumb" class="hide">
	<a href="http://codrcg.com/<?php echo MW3_Folder; ?>" itemprop="url">
		<span itemprop="title">Modern Warfare 3 RCG</span>
	</a> <?php echo ($_SERVER['REQUEST_URI'] != '/'.MW3_Folder.'/' ? '›':''); ?>
</div>
