app.service('MainService', function ($http, $q) {
	...
	this.createClass = function(data){
		var deferred = $q.defer();
		var results = $http.post("includes/send/createClass.php", $.param({data:data}), {headers : {'Content-Type': 'application/x-www-form-urlencoded'}});
	...
	this.saveSettings = function(data){
		var deferred = $q.defer();
		var results = $http.post("includes/send/saveSettings.php", $.param({data:data}), {headers : {'Content-Type': 'application/x-www-form-urlencoded'}});
