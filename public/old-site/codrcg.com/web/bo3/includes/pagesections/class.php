...
<div class='row'>
	<div class="col s12">		
			...
			<div class="col s4" id="Lethal">
				...
				<?php
					if(isset( $class[ 'Data' ][ 'Lethal' ] )){
						echo $class[ 'Data' ][ 'Lethal' ]['Name'].(isset($class[ 'Data' ]['DangerClose']) ? ' <strong>x2</strong>' : '');
					} else if(isset( $class[ 'Data' ][ 'Tactician' ] )) {
			...
			<div class="col s4" id="Tactical">
				...
				<?php
					if(isset( $class[ 'Data' ][ 'Tactical' ] )){
						echo $class[ 'Data' ][ 'Tactical' ][ 'Name' ] . ( $class[ 'Data' ][ 'Frame' ][ 'Tactical' ] == 2 ? ' <strong>x2</strong>' : '' );
					} else{
						echo '<span>None</span>';
					}
				?>
		...
		<?php
			if (isset($class['Data']['Specialist']) || isset($class['Data']['Gamemode']) || isset($class['Data']['Challenge'])) {
				echo '<div class="divider"></div>';

				echo '<div class="row text-center">';
					if (isset($class['Data']['Specialist'])) {
						echo '<div class="col s4">
								<h3>Specialist</h3>
								<span>'.$class['Data']['Specialist'].'</span> 
							</div>';
					}
