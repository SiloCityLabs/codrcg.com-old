...
?>
	...
	<link rel="apple-touch-icon" href="/<?php echo IW_Folder; ?>/apple-touch-icon.png">
    <link rel="android-touch-icon" href="/<?php echo IW_Folder; ?>/apple-touch-icon.png">
    <meta name="google-play-app" content="app-id=com.techreanimate.blackops3">
    <link rel='shortcut icon' href='/<?php echo IW_Folder; ?>/favicon.ico' type='image/x-icon' />
	...
	<?php
		...
		echo minify_builder([
			...
			'files'=>[
				...
				IW_Folder .'/assets/scripts/_app/app.js',
				'assets/scripts/_app/BootstrapMediaQuieres.js',
				'assets/scripts/_app/filters/filters.js',
				IW_Folder .'/assets/scripts/_app/main/main.controller.js',
				IW_Folder .'/assets/scripts/_app/main/main.service.js',
...
<?php require('includes/pagesections/iw_schema.php'); ?>
<!-- SEO breadcrubs -->
...
<div itemscope itemtype="http://data-vocabulary.org/Breadcrumb" class="hide">
	<a href="http://codrcg.com/<?php echo IW_Folder; ?>" itemprop="url">
		<span itemprop="title">Infinite Warfare RCG</span>
	</a> <?php echo ($_SERVER['REQUEST_URI'] != '/'.IW_Folder.'/' ? '›':''); ?>
</div>
