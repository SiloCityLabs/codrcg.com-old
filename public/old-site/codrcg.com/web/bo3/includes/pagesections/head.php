...
?>
	...
	<link rel="apple-touch-icon" href="/<?php echo BO3_Folder; ?>/apple-touch-icon.png">
    <link rel="android-touch-icon" href="/<?php echo BO3_Folder; ?>/apple-touch-icon.png">
    <meta name="google-play-app" content="app-id=com.techreanimate.blackops3">
    <link rel='shortcut icon' href='/<?php echo BO3_Folder; ?>/favicon.ico' type='image/x-icon' />
	...
	<?php
		...
		echo minify_builder([
			...
			'files'=>[
				...
				BO3_Folder.'/assets/scripts/_app/app.js',
				'assets/scripts/_app/BootstrapMediaQuieres.js',
				'assets/scripts/_app/filters/filters.js',
				BO3_Folder.'/assets/scripts/_app/main/main.controller.js',
				BO3_Folder.'/assets/scripts/_app/main/main.service.js',
				'assets/lib/smart-banner/smart-app-banner.js',
				BO3_Folder.'/assets/scripts/main.js',
				'assets/scripts/main.js'
			]
		]);
?>
<?php require( '../includes/pagesections/ads/page_level.php' ); ?>
<?php require('includes/pagesections/bo3_schema.php'); ?>
<!-- SEO breadcrubs -->
...
<div itemscope itemtype="http://data-vocabulary.org/Breadcrumb" class="hide">
	<a href="http://codrcg.com/<?php echo BO3_Folder; ?>" itemprop="url">
		<span itemprop="title">Black Ops 3 RCG</span>
	</a> <?php echo ($_SERVER['REQUEST_URI'] != '/'.BO3_Folder.'/' ? '›':''); ?>
</div>