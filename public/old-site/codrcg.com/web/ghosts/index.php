<?php
	...
	$seoArr['keywords'] = 'Call of duty, call, of, duty, cod, call of duty, random, class, generator, random class generator, rcg,
		free, mp, multiplayer, call of duty random class generator, COD Ghosts RCG, ghosts random class generator,
		ghosts, infinity ward';


	$TotalClasses = getconfig ('Cached_GH_Class_Count');
?>
		...
		<form name="myForm" class="col s12">
			<div class="row text-center">
				<div class="col s12 m9 l9">
					<h1>Ghosts Random Class Generator</h1>
				</div>
			</div>
			<div class="row">
				<div class="col s12 m9 l9">
					<div id='top' class="text-center">
						...
						<h2 class="smallH2">Designed to generate a random class for players to use in Ghosts.</h2>
					...
					<div class="text-center">
						<a class="waves-effect waves-light btn blue darken-2" href="/<?php echo GH_Folder; ?>/class" ng-disabled='myForm.$invalid'>
