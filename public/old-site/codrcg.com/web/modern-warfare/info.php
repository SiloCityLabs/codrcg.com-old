<?php
    ...
    $seoArr['desc'] = 'The page for create a class information in call of duty 4 modern warfare.';
    $seoArr['keywords'] = 'COD 4 Modern Warfare RCG, modern warfare, modern warfare random class generator, COD 4 RCG';
