app.service('MainService', function ($http, $q) {
	this.InitialInfo = function(){
		...
		var results = $http.post("/bo3/includes/send/InitialInfo.php");
	...
	this.createClass = function(data){ 
		var deferred = $q.defer();
		var results = $http.post("/bo3/includes/send/createClass.php", $.param({data:data}), {headers : {'Content-Type': 'application/x-www-form-urlencoded'}});
	...
	this.saveSettings = function(data){ 
		var deferred = $q.defer();
		var results = $http.post("/bo3/includes/send/saveSettings.php", $.param({data:data}), {headers : {'Content-Type': 'application/x-www-form-urlencoded'}});
