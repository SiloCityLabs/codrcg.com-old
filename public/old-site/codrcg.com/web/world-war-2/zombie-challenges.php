<?php
	...
	new Session(['ALL']);
	$seoArr['title'] = 'Zombies Challenges - '.WW2_Title;
	$seoArr['desc'] = 'A list of zombies challenges to challenge and add a new level of fun to Black Ops 3 zombies.';
	$seoArr['keywords'] = 'COD World War II, COD WWII, WWII, world war II, world war 2, zombies, sledgehammer games, sledgehammer games zombies, zombies challenges';
	$seoArr['url'] = '//'.SYS_URL_PATH.'/'.WW2_Folder.'/zombie-challenges';
	...
	<?php
		echo minify_builder ([
			...
			'files' => [
				...
				WW2_Folder.'/assets/scripts/pages/zombie-challenges/main.controller.js'
			]
		]);
	?>
