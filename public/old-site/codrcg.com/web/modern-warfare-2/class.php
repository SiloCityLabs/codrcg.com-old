<?php
	...
	if (!empty($_GET['ID'])) {
		...
		header ("location: ".'/'.MW2_Folder."/includes/send/createClass.php");
		exit();
	}
	$seoArr['title'] = 'Class - '.MW2_Title;
	...
	$seoArr['url'] = 'https://'.SYS_URL_PATH.'/'.MW2_Folder.'/class/'.$classID;
			...
			<div class='row'>
				<div class="col s12">
					...
					<div class="row text-center" ng-cloak>
						...
						<?php gunLayout($class['Data'],'Secondary'); ?>
					</div>
					...
					<div class="row text-center" ng-cloak>
						...
						<?php equipLayout($class['Data'],'Special_Grenade',1,'s6'); ?>
					</div>
