<?php
	...
	/* Get The menu */
	$menu[] = ['Name' => 'Black Ops', 'Href' => '/'.BO_Folder];
	$menu[] = ['Name' => 'Shoutouts', 'Href' => '/shoutouts'];
	//$menu[] = ['Name' => 'Class Info', 'Href' => '/'.BO_Folder.'/info'];
	//$menu[] = ['Name' => 'Stats', 'Href' => '/'.BO_Folder.'/stats'];
	//$menu['Zombies'][] = ['Name' => 'Zombie Challenges', 'Href' => '/'.BO_Folder.'/zombie-challenges'];
	/* Cod menu */
			...
			<ul class="side-nav" id="mobile-demo">
	      	...
	      	<ul class="right" ng-cloak>
				...
				<?php if (strpos ($_SERVER['SCRIPT_FILENAME'], 'class.php') !== FALSE): ?>
					<li>
						<a href='/<?php echo BO_Folder; ?>/class' class="tooltipped" data-position="bottom" data-delay="50" data-tooltip="Roll new class">
