<?php
	...
	new Session(['ALL']);
	$seoArr['title'] = 'Shoutouts - '.SITE_NAME;
	$seoArr['desc'] = 'A list of people we find on twitch or youtube that use our product.';
	$seoArr['keywords'] = 'Call of duty, twitch, youtube, shoutouts';
	$seoArr['url'] = '//'.SYS_URL_PATH.'/shoutouts';
...
?>
	<div ng-app ='MainApp' class="ng-scope" class="row" ng-controller='PagCtrl as pagCtrl'
