<?php
	...
	$seoArr['keywords'] = 'Call of duty, call, of, duty, cod, call of duty, random, class, generator, random class generator, rcg,
		free, mp, multiplayer, call of duty random class generator, COD Ghost RCG, ghosts random class generator,
		...
		<form name="myForm" class="col s12">
			<div class="row text-center">
				<div class="col s12 m9 l9">
					<h1>Ghost Random Class Generator</h1>
				</div>
			</div>
			<div class="row">
				<div class="col s12 m9 l9">
					<div id='top' class="text-center">
						...
						<h2 class="smallH2">Designed to generate a random class for players to use in Ghost.</h2>
