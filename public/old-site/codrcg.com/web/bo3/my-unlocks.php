<?php
	...
	$seoArr['title'] = 'My Unlocks - '.BO3_Title;
	$seoArr['desc'] = 'Where you select your perma unlocks from prestiging in call of duty black ops 3.';
	$seoArr['keywords'] = 'COD Black Ops 3, COD Blops 3, blops 3, black ops 3, ops 3, treyarch, twitch, youtube, unlocks';
	$seoArr['url'] = '//'.SYS_URL_PATH.'/'.BO3_Folder.'/my-unlocks';
?>
