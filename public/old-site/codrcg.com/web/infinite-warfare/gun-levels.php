<?php
	...
	$seoArr['title'] = 'Gun Levels - '.IW_Title;
	$seoArr['desc'] = 'Where you set your gun levels. This will be used when rolling attachments for guns in call of duty infinite warfare.';
	$seoArr['keywords'] = 'COD Infinite Warfare, Infinite Warfare, infinity ward, twitch, youtube, gun levels';
	$seoArr['url'] = '//'.SYS_URL_PATH.'/'.IW_Folder.'/gun-levels';
				...
				<div class="row">
					<div class="col s12">
						<div class="text-center">
							<a class="waves-effect waves-light btn yellow accent-2" ng-click='myCtrl.setInfo();' ng-disabled='myForm.$invalid'>
