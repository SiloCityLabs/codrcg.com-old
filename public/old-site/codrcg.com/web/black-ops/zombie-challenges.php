<?php
	...
	new Session(['ALL']);
	$seoArr['title'] = 'Zombies Challenges - '.BO_Title;
	$seoArr['desc'] = 'A list of zombies challenges to challenge and add a new level of fun to Black Ops zombies.';
	$seoArr['keywords'] = 'COD Black Ops Zombies, COD Blops Zombies, blops zombies, blops, black ops, ops zombies,
		ops zombies, zombies, treyarch, treyarch zombies, zombies challenges';
	$seoArr['url'] = '//'.SYS_URL_PATH.'/'.BO_Folder.'/zombie-challenges';
	...
	<?php
		echo minify_builder ([
			...
			'files' => [
				...
				BO_Folder.'/assets/scripts/pages/zombie-challenges/main.controller.js'
			]
		]);
	?>
