<?php
    ...
    /* Get The menu */
	$menu[] = ['Name' => 'Modern Warfare 3', 'Href' => '/'.MW3_Folder];
    $menu[] = ['Name' => 'Shoutouts', 'Href' => '/shoutouts'];
	$menu[] = ['Name' => 'Class Info', 'Href' => '/'.MW3_Folder.'/info'];
	$menu[] = ['Name' => 'Stats', 'Href' => '/'.MW3_Folder.'/stats'];
            ...
            <div class="nav-wrapper">
                ...
                <ul class="right" ng-cloak>
                    ...
                    <?php if (strpos ($_SERVER['SCRIPT_FILENAME'], 'class.php') !== FALSE): ?>
                        <li>
                            <a href='/<?php echo MW3_Folder; ?>/class' class="tooltipped" data-position="bottom" data-delay="50" data-tooltip="Roll new class">
