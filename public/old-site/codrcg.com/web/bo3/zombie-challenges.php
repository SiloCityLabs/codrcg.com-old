<?php
	...
	new Session(['ALL']);
	$seoArr['title'] = 'Zombies Challenges - '.BO3_Title;
	...
	$seoArr['keywords'] = 'COD Black Ops 3 Zombies, COD Blops 3 Zombies, blops 3 zombies, blops 3, black ops 3, ops 3 zombies, 
		ops 3 zombies, zombies, treyarch, treyarch zombies, zombies challenges';
	$seoArr['url'] = '//'.SYS_URL_PATH.'/'.BO3_Folder.'/zombie-challenges';
	...
	<?php
		echo minify_builder ([
			...
			'files' => [
				...
				BO3_Folder.'/assets/scripts/pages/zombie-challenges/main.controller.js'
			]
		]);
	?>
