<?php
	...
	$seoArr['title'] = 'Gun Levels - '.BO2_Title;
	$seoArr['desc'] = 'Where you set your gun levels. This will be used when rolling attachments for guns.';
	$seoArr['keywords'] = 'COD Black Ops 2, COD Blops 2, blops 2, black ops 2, ops 2, treyarch, twitch, youtube, gun levels';
	$seoArr['url'] = '//'.SYS_URL_PATH.'/'.BO2_Folder.'/gun-levels';
