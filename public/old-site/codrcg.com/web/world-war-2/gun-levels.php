<?php
	...
	$seoArr['title'] = 'Gun Levels - '.WW2_Title;
	...
	$seoArr['url'] = '//'.SYS_URL_PATH.'/'.WW2_Folder.'/gun-levels';
				...
				<div class="row">
					<div class="col s12">
						<div class="text-center">
							<a class="waves-effect waves-light btn cod WWII" ng-click='myCtrl.setInfo();' ng-disabled='myForm.$invalid'>Save</a>
						</div>
					</div>
				</div>
			</form>
