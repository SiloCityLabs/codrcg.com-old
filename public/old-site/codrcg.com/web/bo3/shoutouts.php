<?php
	...
	new Session(['ALL']);
	$seoArr['title'] = 'Shoutouts - '.BO3_Title;
	$seoArr['desc'] = 'A list of people we find on twitch or youtube that use our product.';
	$seoArr['keywords'] = 'COD Black Ops 3, COD Blops 3, blops 3, blops 3, black ops 3, ops 3, treyarch, twitch, youtube, shoutouts';
	$seoArr['url'] = '//'.SYS_URL_PATH.'/'.BO3_Folder.'/shoutouts';
