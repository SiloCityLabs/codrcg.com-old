<?php
	...
	$seoArr['keywords'] = 'Call of duty, call, of, duty, cod, call of duty, random, class, generator, random class generator, rcg,
		free, mp, multiplayer, call of duty random class generator, COD Black Ops 2 RCG, COD Blops 2 RCG, blops 2 random class generator,
		blops 2, black ops 2, ops 2 rcg, ops 2 random class generator, black ops 2 random class generator, zombies, treyarch zombies,
		black ops zombies, black ops 2 zombies, black ops rcg, black ops random class generator';


	$TotalClasses = getconfig ('Cached_BO2_Class_Count');
?>
		...
		<form name="myForm" class="col s12">
			<div class="row text-center">
				<div class="col s12 m9 l9">
					<h1>Black Ops 2 Random Class Generator</h1>
				</div>
			</div>
			<div class="row">
				<div class="col s12 m9 l9">
					<div id='top' class="text-center">
						...
						<h2 class="smallH2">Designed to generate a random class for players to use in Black Ops 2.</h2>
					...
					<div class="text-center">
						<a class="waves-effect waves-light btn orange accent-4" href="/<?php echo BO2_Folder; ?>/class" ng-disabled='myForm.$invalid'>
