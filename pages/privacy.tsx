...
export default function Changelog() {
  return (
    <>
      <Head>
        <title>Privacy Policy - Call Of Duty Random Class Generator</title>
        <link rel="manifest" href="/manifest.json" />
        <meta
          name="description"
          content="This is the privacy policy for codrcg."
        />
        <meta
          name="keywords"
          content="call of duty, cod, rcg, codrcg, cod rcg, privacy policy"
        />
      </Head>
