<?php
	...
	$seoArr['desc'] = 'A handy utility to generate random classes for Call of duty Modern Warfare 2. This adds a new level of fun to the game by generating random classes for you to enjoy';
	$seoArr['keywords'] = 'Call of duty, cod, random class generator, rcg, free, mp, multiplayer, call of duty random class generator, COD modern warfare 2 RCG, modern warfare 2, modern warfare 2 random class generator, infinity ward';

	$TotalClasses = getconfig ('Cached_MW2_Class_Count');
?>
		...
		<form name="myForm" class="col s12">
			<div class="row text-center">
				<div class="col s12 m9 l9">
					<h1>Modern Warfare 2 Random Class Generator</h1>
				</div>
			</div>
			<div class="row">
				<div class="col s12 m9 l9">
					<div id='top' class="text-center">
						...
						<span>Designed to generate a random class for players to use in Call of Duty: Modern Warfare 2.</span><br>
					...
					<div class="text-center">
						<a class="waves-effect waves-light btn green accent-4" href="/<?php echo MW2_Folder; ?>/class" ng-disabled='myForm.$invalid'>
