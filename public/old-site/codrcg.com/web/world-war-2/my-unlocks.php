<?php
	...
	$seoArr['title'] = 'My Unlocks - '.WW2_Title;
	$seoArr['desc'] = 'Where you select your perma unlocks from prestiging in call of duty world war 2.';
	$seoArr['keywords'] = 'COD World War II, COD WWII, WWII, world war II, world war 2, sledgehammer games, twitch, youtube, gun levels';
	$seoArr['url'] = '//'.SYS_URL_PATH.'/'.WW2_Folder.'/my-unlocks';
?>
				...
				<div class="row">
					<div class="col s12">
						<div class="text-center">
							<a class="waves-effect waves-light btn cod WWII" ng-click='myCtrl.setUnlockInfo();' ng-disabled='myForm.$invalid'>Save</a>
						</div>
					</div>
				</div>
			</form>
