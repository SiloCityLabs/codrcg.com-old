<?php 
	...
	if(!isset($clean)) exit();
?>
<p>This Privacy Policy governs the manner in which Techreanimate collects, uses, maintains and discloses information collected from users (each, a "User") of the http://<?php echo SYS_URL_PATH; ?> website ("Site"). This privacy policy applies to the Site and all products and services offered by Techreanimate.</p>
<br>
<h1>What information do we collect?</h1>
<p>We collect information from you when you register on our site, place an order, subscribe to our newsletter, respond to a survey or fill out a form.</p>
<p>When ordering or registering on our site, as appropriate, you may be asked to enter your: name, e-mail address, mailing address, phone number or Techreanimate. You may, however, visit our site anonymously.</p>
<br>
<h1>What do we use your information for?</h1>
<p>Any of the information we collect from you may be used in one of the following ways:</p>
<ol style="list-style: circle; padding: 20px;">
...
<p>As part of the California Online Privacy Protection Act, all users of our site may make any changes to their information at anytime by logging into their account and going to the 'My Account' page.</p>
<br>
...
<p>Please also visit our Terms and Conditions section establishing the use, disclaimers, and limitations of liability governing the use of our website at <a href="http://<?php echo SYS_URL_PATH;?>/terms">http://<?php echo SYS_URL_PATH;?>/terms</a></p>
<br>
<h1>Your Consent</h1>
...
<p>This policy was last modified on 10/26/2013 4:17PM EST</p>
<br>
<h1>Contacting Us</h1>
