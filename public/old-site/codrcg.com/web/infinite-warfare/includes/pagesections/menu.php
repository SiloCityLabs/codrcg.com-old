<?php
    ...
    /* Get The menu */
    $menu[] = ['Name' => 'Infinite Warfare', 'Href' => '/'.IW_Folder];
    $menu[] = ['Name' => 'Gun Levels', 'Href' => '/'.IW_Folder.'/gun-levels'];
    $menu[] = ['Name' => 'My Unlocks', 'Href' => '/'.IW_Folder.'/my-unlocks'];
    $menu[] = ['Name' => 'Shoutouts', 'Href' => '/shoutouts'];
    $menu[] = ['Name' => 'Class Info', 'Href' => '/'.IW_Folder.'/info'];
    $menu[] = ['Name' => 'Stats', 'Href' => '/'.IW_Folder.'/stats'];
    //$menu['Zombies'][] = ['Name' => 'Zombie Challenges', 'Href' => '/'.IW_Folder.'/zombie-challenges'];
    /* Cod menu */
    ...
    $menuString = '<li> <a href="/" class="black-text"> <i class="material-icons">home</i> </a> </li>';
    ...
    foreach ($menu as $key => $value) {
        if (!is_numeric ($key)) {
            ...
            $menuString .= "
					<a class='dropdown-button black-text' data-beloworigin='true' href='#' data-activates='$key-nav' data-constrainwidth='false'>
            ...
            $menuString .= "<li class='collection-item'><a class='black-text' href='$value[Href]'>$value[Name]</a></li>";
...
<div class="navbar-fixed">
    <nav class="yellow accent-2" role="navigation">
        <div class="nav-wrapper">
            ...
            <ul class="left hide-on-med-and-down black-text" ng-cloak>
                <?php echo $menuString; ?>
            </ul>
            ...
            <ul class="right" ng-cloak>
                ...
                <?php if (strpos ($_SERVER['SCRIPT_FILENAME'], 'class.php') !== FALSE): ?>
                    <li>
                        <a href='/<?php echo IW_Folder; ?>/class' class="tooltipped" data-position="bottom"
                           data-delay="50" data-tooltip="Roll new class">
                    ...
                    <li>
                        <a href="#" class="dropdown-button tooltipped" data-position="bottom" data-delay="50"
                           data-tooltip="Share" data-activates='socialDropdown' data-constrainwidth='false'>
                            <i class="material-icons black-text">share</i>
                        </a>
                    </li>
                <?php else: ?>
                    <li>
                        <a href="<?php echo App_Short_Link; ?>" class="tooltipped" data-position="bottom" data-delay="50"
                ...
                <li><a href="#" class="dropdown-button tooltipped" data-position="bottom" data-delay="50"
                       data-tooltip="Settings" data-activates='settingsDropdown' data-constrainwidth='false'><i
