<?php
	...
	if (!empty($_GET['ID'])) {
		...
		header("location: " . '/' . BO3_Folder . "/includes/send/createClass.php");
		exit();
	}

	$seoArr['title'] = 'Class - '.BO3_Title;
	...
	$seoArr['keywords'] = 'Call of duty, random class generator, multiplayer, call of duty random class generator, COD Black Ops 3 RCG,
		black ops 3, black ops 3 random class generator, zombies, treyarch';
	$seoArr['url'] = 'https://'.SYS_URL_PATH.'/'.BO3_Folder.'/class/'.$classID;
