...
?>
	...
	<link rel="apple-touch-icon" href="/<?php echo WW2_Folder; ?>/apple-touch-icon.png">
    <link rel="android-touch-icon" href="/<?php echo WW2_Folder; ?>/apple-touch-icon.png">
    <meta name="google-play-app" content="app-id=com.techreanimate.blackops3">
    <link rel='shortcut icon' href='/<?php echo WW2_Folder; ?>/favicon.ico' type='image/x-icon' />
	...
	<?php
		echo minify_builder([
			...
			'files'=>[
				...
				'assets/css/'.WW2_Folder.'/main.css',
		...
		echo minify_builder([
			...
			'files'=>[
				...
				WW2_Folder.'/assets/scripts/_app/app.js',
				'assets/scripts/_app/BootstrapMediaQuieres.js',
				'assets/scripts/_app/filters/filters.js',
				WW2_Folder.'/assets/scripts/_app/main/main.controller.js',
				WW2_Folder.'/assets/scripts/_app/main/main.service.js',
				'assets/lib/smart-banner/smart-app-banner.js',
				WW2_Folder.'/assets/scripts/main.js',
...
<div itemscope itemtype="http://data-vocabulary.org/Breadcrumb" class="hide">
	<a href="http://codrcg.com/<?php echo WW2_Folder; ?>" itemprop="url">
		<span itemprop="title">Black Ops 2 RCG</span>
	</a> <?php echo ($_SERVER['REQUEST_URI'] != '/'.WW2_Folder.'/' ? '›':''); ?>
</div>