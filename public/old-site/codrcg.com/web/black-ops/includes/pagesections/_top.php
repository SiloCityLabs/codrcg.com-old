<?php
    $seoArr['title'] = (!empty($seoArr['title']) ? $seoArr['title'] : BO_Title);
    $seoArr['image'] = (!empty($seoArr['image']) ? $seoArr['image'] : BO_Image);
    $seoArr['desc'] = (!empty($seoArr['desc']) ? $seoArr['desc'] : '');
    $seoArr['keywords'] = (!empty($seoArr['keywords']) ? $seoArr['keywords'] : '');
    $seoArr['url'] = (!empty($seoArr['url']) ? $seoArr['url'] : 'https://'.SYS_URL_PATH.'/'.BO_Folder);
?>
