...
export default function Terms() {
  return (
    <>
      <Head>
        <title>
          Terms And Conditions - Call Of Duty Random Class Generator
        </title>
        <link rel="manifest" href="/manifest.json" />
        <meta
          name="description"
          content="This is the terms and conditions for codrcg."
        />
        <meta
          name="keywords"
          content="call of duty, cod, rcg, codrcg, cod rcg, terms and conditions"
        />
      </Head>
