app.service('MainService', function ($http, $q) {
	this.InitialInfo = function(){
		...
		var results = $http.post("/infinite-warfare/includes/send/InitialInfo.php");
	...
	this.createClass = function(data){ 
		var deferred = $q.defer();
		var results = $http.post("/infinite-warfare/includes/send/createClass.php", $.param({data:data}), {headers : {'Content-Type': 'application/x-www-form-urlencoded'}});
	...
	this.saveSettings = function(data){ 
		var deferred = $q.defer();
		var results = $http.post("/infinite-warfare/includes/send/saveSettings.php", $.param({data:data}), {headers : {'Content-Type': 'application/x-www-form-urlencoded'}});
