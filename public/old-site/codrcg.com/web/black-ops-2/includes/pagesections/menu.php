<?php
	...
	/* Get The menu */
	$menu[] = ['Name' => 'Black Ops 2', 'Href' => '/'.BO2_Folder];
	$menu[] = ['Name' => 'Gun Levels', 'Href' => '/'.BO2_Folder.'/gun-levels'];
	$menu[] = ['Name' => 'My Unlocks', 'Href' => '/'.BO2_Folder.'/my-unlocks'];
	$menu[] = ['Name' => 'Shoutouts', 'Href' => '/shoutouts'];
	$menu[] = ['Name' => 'Class Info', 'Href' => '/'.BO2_Folder.'/info'];
	$menu[] = ['Name' => 'Stats', 'Href' => '/'.BO2_Folder.'/stats'];
	$menu['Zombies'][] = ['Name' => 'Zombie Challenges', 'Href' => '/'.BO2_Folder.'/zombie-challenges'];
	/* Cod menu */
			...
			<ul class="side-nav" id="mobile-demo">
	      	...
	      	<ul class="right" ng-cloak>
				...
				<?php if (strpos ($_SERVER['SCRIPT_FILENAME'], 'class.php') !== FALSE): ?>
					<li>
						<a href='/<?php echo BO2_Folder; ?>/class' class="tooltipped" data-position="bottom" data-delay="50" data-tooltip="Roll new class">
...
<?php if (strpos ($_SERVER['SCRIPT_FILENAME'], 'class.php') !== FALSE): ?>
	<ul id='socialDropdown' class='dropdown-content'>
		<li class="text-center">
			<a ng-href="https://twitter.com/intent/tweet?hashtags=Blackops2&text=Check out this Black Ops 2 Random Class!&url=<?php echo $class['TinyUrl']; ?>&via=silocitylabs"
			   onclick="javascript:window.open(this.href, '', 'menubar=no,toolbar=no,resizable=yes,scrollbars=yes,height=300,width=600');return false;">
				<i class="fa fa-twitter-square"></i>
			</a>
		</li>
		<li class="text-center">
			<a ng-href="http://www.facebook.com/sharer/sharer.php?u=<?php echo $class['TinyUrl']; ?>&t=Black Ops 2 Random Class Generator"
			   onclick="javascript:window.open(this.href, '', 'menubar=no,toolbar=no,resizable=yes,scrollbars=yes,height=300,width=600');return false;">
