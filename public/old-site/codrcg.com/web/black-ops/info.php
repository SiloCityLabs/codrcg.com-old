<?php
	...
	$seoArr['title'] = 'Create-A-Class Information - '.BO_Title;
	$seoArr['desc'] = 'The page for create a class information in black ops';
	$seoArr['keywords'] = 'COD Black Ops RCG, COD Blops RCG, blops random class generator, blops, black ops, ops rcg,
		ops random class generator';
	$seoArr['url'] = '//'.SYS_URL_PATH.'/'.BO_Folder.'/info';
