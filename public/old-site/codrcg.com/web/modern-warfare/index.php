<?php
	...
	$seoArr['keywords'] = 'Call of duty, cod, random class generator, rcg, free, mp, multiplayer, call of duty random class generator, COD modern warfare RCG, modern warfare, modern warfare random class generator, infinity ward';

	$TotalClasses = getconfig ('Cached_MW_Class_Count');
?>
		...
		<form name="myForm" class="col s12">
			<div class="row text-center">
				<div class="col s12 m9 l9">
					<h1>Modern Warfare Random Class Generator</h1>
				</div>
			</div>
			<div class="row">
				<div class="col s12 m9 l9">
					<div id='top' class="text-center">
						...
						<span>Designed to generate a random class for players to use in Call of Duty 4: Modern Warfare.</span><br>
						<span>Some Features of this class generator are:</span><br>
						<span>
							All Weapons, Attachments, Perks, &amp; Special Grenades are included.<br>
					...
					<div class="text-center">
						<a class="waves-effect waves-light btn green accent-4" href="/<?php echo MW_Folder; ?>/class" ng-disabled='myForm.$invalid'>
